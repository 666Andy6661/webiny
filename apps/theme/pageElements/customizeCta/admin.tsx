...
import { CustomizeCta, CustomizeCtaProps } from "./CustomizeCta";
...
const INITIAL_ELEMENT_DATA: CustomizeCtaProps = {
    variables: {
      iconSrc: "",
      iconSize: "",
      iconColor: "",
...
export default  [
        {
            name: "pb-editor-page-element-customize-cta",
            type: "pb-editor-page-element",

            elementType: "customize-cta",

            toolbar: {
                title: "Custom CTA button",
        ...
        {
            name: "pb-editor-page-element-advanced-settings-customize-cta",
